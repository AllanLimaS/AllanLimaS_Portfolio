          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            {projeto.data.github && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center border border-outline-variant/30 text-on-surface px-4 py-3 rounded-xl font-label-sm hover:bg-white/5 transition-all"
              >
